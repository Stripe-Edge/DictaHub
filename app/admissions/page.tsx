      ...
      >
        ...
        >
          ...
          <Select
            ...
            options={[
              { value: "ai-automation-llms", label: "AI Automation & LLMs" },
              { value: "data-ml", label: "Data Science & Machine Learning" },
            ]}
          ...
          <div>
            <label className="mb-2 text-gray-800 font-semibold block">
